...
define amdgpu_kernel void @partial_copy(<4 x i32> %arg) #0 {
  ...
  ; REGALLOC-GFX908-NEXT:   [[LR_SPLIT_COPY:%[0-9]+]]:av_128 = LR_SPLIT_COPY %26
  ...
  ; REGALLOC-GFX908-NEXT:   [[LR_SPLIT_COPY1:%[0-9]+]]:vreg_128 = LR_SPLIT_COPY [[LR_SPLIT_COPY]]
  ; REGALLOC-GFX908-NEXT:   GLOBAL_STORE_DWORDX4 undef %14:vreg_64, [[LR_SPLIT_COPY1]], 0, 0, implicit $exec :: (volatile store (s128) into `ptr addrspace(1) undef`, addrspace 1)
  ...
  ; REGALLOC-GFX90A-NEXT:   [[LR_SPLIT_COPY:%[0-9]+]]:av_128_align2 = LR_SPLIT_COPY %25
  ...
  ; REGALLOC-GFX90A-NEXT:   GLOBAL_STORE_DWORDX4 undef %14:vreg_64_align2, [[LR_SPLIT_COPY]], 0, 0, implicit $exec :: (volatile store (s128) into `ptr addrspace(1) undef`, addrspace 1)
